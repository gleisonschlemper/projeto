...
public class email {
	    ...
	    private static String emailFrom = "dev.schlemper@gmail.com";
	    private static String passwordFrom = "vlrq pyfd gdtn yhve";
	    private static String emailTo = "gleisonschlemper532@gmail.com";
